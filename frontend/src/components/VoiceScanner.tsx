        ...
        try {
            ...
            const stream = await navigator.mediaDevices.getUserMedia({
                audio: {
                    ...
                    noiseSuppression: true, // Switched to true for better clarity
            ...
            const updateVolume = () => {
                ...
                // Log a warning if it's dead silent for too long
                if (average === 0 && Math.random() < 0.05) {
                    console.warn("🔇 Microphone is currently reporting absolute silence.");
                }
            ...
            recorder.onstop = () => {
                console.log("🛑 Recorder stopped. Total chunks collected:", chunksRef.current.length);
                ...
                console.log("💎 Final Audio Blob created:", blob.size, "bytes", "Type:", blob.type);
                ...
                stream.getTracks().forEach(track => {
                    track.stop();
                    console.log("✅ Track stopped:", track.label, "| State:", track.readyState);
                });
            ...
            // Start with a timeslice to ensure data flows
            recorder.start(100);
